...
class ClientsService {
  ...
  Future<List<GetApprovedDetailsObjct>?> getClients(String startDate,String endDate) async {
    try {
      String url="http://mapp.yemensoft.net/WEBONYXMOBILEV2/Service1.svc/GetApprovedDetails?YearNo=2021&ActvieNo=1&P_USR_NO=1&P_DOC_TYP=53&P_APPRVD=0&P_LVL_NO=NULL&P_F_DOC_NO=NULL&P_T_DOC_NO=NULL&P_F_DOC_DATE='${startDate.isNotEmpty?startDate:null}'&P_T_DOC_DATE='${endDate.isNotEmpty?endDate:null}'&DOC_SER=&Lang_No=1&op_type=1";
